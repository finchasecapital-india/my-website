...
const IND_NEW = [[300000, 0], [700000, .05], [1000000, .10], [1200000, .15], [1500000, .20], [Infinity, .30]];
...
const R = {
  ...
  msme: { micro: [1e7, 5e7], small: [1e8, 5e8], medium: [5e8, 2.5e9] },
  ...
  verified: "Apr 2026 · FY 2025-26 (built-in)"
};
async function loadRates() {
  ...
  try {
    ...
    if (note) note.textContent = "Rates baseline: FY 2025-26 (Apr 2026), showing built-in figures.";
  }
}
...
{ id: "profit-tax", render: "calc", type: "Calculator", cat: "founders",
  ...
  compute(v) {
    ...
    return { rows, note: "87A rebate applied (nil tax up to ₹5L old / ₹7L new). Before personal deductions, use the Regime Comparator for deduction-adjusted math." };
  }
},
{ id: "msme", render: "calc", type: "Calculator", cat: "founders",
  ...
  verified: "Apr 2026 · composite criteria as notified",
  assumptions: ["Micro: investment ≤ ₹1 Cr and turnover ≤ ₹5 Cr. Small: ≤ ₹10 Cr and ≤ ₹50 Cr. Medium: ≤ ₹50 Cr and ≤ ₹250 Cr.", "Both conditions must hold simultaneously; classification follows the lower of the two."],
  inputs: [

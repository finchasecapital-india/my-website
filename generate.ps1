...
function Head($title, $desc, $path, $nested, $schema, $keywords) {
  $pre = P $nested
  $canon = 'https://finchasecapital.com/' + $path
  $kwTag = ''
...
__KEYWORDS__
  ...
  <meta property="og:image" content="https://finchasecapital.com/images/og-logo.png">
  <meta property="og:type" content="website">
  <meta name="twitter:card" content="summary_large_image">
  <meta name="twitter:title" content="__TITLE__">
  <meta name="twitter:description" content="__DESC__">
  <meta name="twitter:image" content="https://finchasecapital.com/images/og-logo.png">
...
$svcSchemaItems = ($svc | ForEach-Object -Begin { $script:n = 0 } -Process { $script:n++; '{"@type":"ListItem","position":' + $script:n + ',"name":"' + $_.name + '","url":"https://finchasecapital.com/services/' + $_.slug + '.html"}' }) -join ","
...
$insSchemaItems = ($arts | ForEach-Object { '{"@type":"BlogPosting","headline":"' + $_.title + '","url":"https://finchasecapital.com/insights/' + $_.slug + '.html"}' }) -join ","
